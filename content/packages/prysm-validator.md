...
TODO:
* INtro Set up a Validator for the Ethereum 2.0 Mainnet
* Install geth + consensus client (prysm beacon chain)
* link to key generator
* Run consensus client and validator? 
...
TODO: install Prysm beacon chain

Continue to Step 1 after it has completely synchronized.

## Step 1 : Install Prysm ETH2.0 validator from the DappStore
